package com.dcm.easypoi.util;

import com.dcm.easypoi.cache.ImageCache;
import com.dcm.easypoi.entity.ImageEntity;
import com.dcm.easypoi.excel.annotation.Excel;
import com.dcm.easypoi.excel.annotation.ExcelCollection;
import com.dcm.easypoi.excel.annotation.ExcelEntity;
import com.dcm.easypoi.excel.annotation.ExcelIgnore;
...
public final class PoiPublicUtil {
    ...
    public static Object getRealValue(String currentText,
        ...
        while (currentText.indexOf(PoiElUtil.START_STR) != -1) {
            params = currentText.substring(currentText.indexOf(PoiElUtil.START_STR) + 2, currentText.indexOf(PoiElUtil.END_STR));
            ...
            if (obj instanceof ImageEntity || obj instanceof List || obj instanceof ExcelListEntity) {
                ...
                currentText = currentText.replace(PoiElUtil.START_STR + params + PoiElUtil.END_STR, "");
            }
        }
        return currentText;
    }
    ...
    public static String getElStr(String str, String key) {
        ...
        int startIndex = (str.substring(0, keyIndex)).lastIndexOf(PoiElUtil.START_STR);
        int endIndex = str.indexOf(PoiElUtil.END_STR, keyIndex) + 2;
